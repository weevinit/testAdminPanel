              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                   ...
                   <td>
                        <button type="button" data-amount="{{$result->amount}}"  data-trans="{{$result->transaction_id}}" data-requestid="{{$result->id}}" data-pay="{{$result->payment_method}}" data-id="{{$result->userid}}" data-username="Jhone Doe" data-status="{{$result->status}}" data-toggle="modal" data-target="#addCoin" title="Edit" class="btn btn-icon btn-icon rounded-circle btn-primary bg-darken-4 border-0 edit_buuton">
                    ...
                    <div class="modal-body">
                      <form method="post" action="{{route('update.withdraw.status')}}" data-parsley-validate autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly class="form-control amount_withdraw" name="amount" required />
                            </div>
                        <div class="form-group">
