...
.bottomHalf button {
  ...
  text-transform: uppercase;
	font-family: 'Khand', sans-serif; font-weight: 500; letter-spacing: 1px;
}
...
<div class="wrapperAlert">
  <div class="contentAlert">
    ...
    <div class="bottomHalf">
      <p> Congratulations, Amount successfully Added In Your Account.</p>
      <button id="">PRESS BACK</button>
    </div>
  </div>
</div>
</body>
