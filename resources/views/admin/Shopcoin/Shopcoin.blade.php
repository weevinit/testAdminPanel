 ...
 <!-- BEGIN: Content-->
   ...
   <!-- Bootstrap Validation -->
    <div class="col-md-5 col-12">
      <div class="card">
        <div class="card-header">
          <p class="card-title"><i class="las la-certificate"></i> Add New Shop Coin</p>
        </div>
          ...
          <div class="alert alert-danger alert-dismissible ml-1 mr-1" id="notice_msg" role="alert">
              ...
              @endif
        <div class="card-body">
          <form class="create_brand" method="post" action="{{route('create.shopcoin.new')}}" enctype="multipart/form-data" data-parsley-validate autocomplete="off">
            @csrf
            <div class="form-group">
              <label>Add Shop Coin <span class="text-danger required-sign">*</span></label>
              <input type="number" class="form-control shop_coin" name="shop_coin" required />
            </div>
            <div class="row my-3">
              <div class="col-12">
    ...
    <div class="col-md-7 col-12">
          <div class="card">
      <div class="card-header">
        <p class="card-title"><i class="las la-certificate"></i> All Shop Coin</p>
      </div>
        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="font-weight-bold">{{$result->shop_coin}} ₹</span></td>
              <td>
